...
topo_file <- '../data/USGS_1M_5_x26y220_HI_Hawaii_Island_Lidar_NOAA_2017_B17.tif'
...
# tables of species and sample sizes and variance, historgrams, etc.
# distribution of growth rates
# summary statistics
# maps of species on topography
# maybe restricting to just a couple species would be good
# maps/histograms, spatial heterogeneity
